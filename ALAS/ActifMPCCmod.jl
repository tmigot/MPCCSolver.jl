...
#- stocker les potentiels paramètres de résolution en variables ici.
#Minor :
...
type ActifMPCC
 ...
 #sorties de la minimisation sans contrainte
 #Wolfestep= ***
 #small_step=false
 #step=1.0
 #Armijosuccess=true
...
"""
function ExtddDirection(ma::ActifMPCCmod.ActifMPCC,dr::Vector,xp::Vector,step::Float64)
...
"""
function LSQComputationMultiplier(ma::ActifMPCC,gradpen::Vector,xj::Vector)
...
RelaxationRule(ma::ActifMPCCmod.ActifMPCC,xj::Vector,lg,lh,lphi,wmax)
