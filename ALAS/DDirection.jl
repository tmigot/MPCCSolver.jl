...
SteepestDescent(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
SteepestDescent(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

CGFR(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
CGFR(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

CGPR(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
CGPR(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

CGHS(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
CGHS(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

CGHZ(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
CGHZ(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

BFGS(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
BFGS(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

DFP(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
DFP(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

CGHZ(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
CGHZ(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

NwtdirectionSpectral(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
NwtdirectionSpectral(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

#problème définition MA57 matrice ?
NwtdirectionMA57(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64) 
NwtdirectionMA57(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)

NwtdirectionLDLt(ma::ActifMPCCmod.ActifMPCC,g::Vector,xj::Vector,hd::Any,beta::Float64)
NwtdirectionLDLt(ma::ActifMPCCmod.ActifMPCC,xj::Vector,beta::Float64,gradft,gradf,y,d,step::Float64)
...
#TO DO
# -2ème SteepestDescent ne fait rien ?
# - hd:Any ?
# - gradft,gradf,y,d pas typés
module DDirection
