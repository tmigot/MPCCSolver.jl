...
liste des fonctions :
Quadratic(mp::NLPModels.AbstractNLPModel,err::Vector,nb_comp::Int64,x::Vector,yg::Vector,
...
Lagrangian(mp::NLPModels.AbstractNLPModel,err::Vector,nb_comp::Int64,x::Vector,yg::Vector,
                   yh::Vector,rho::Vector,usg::Vector,ush::Vector,uxl::Vector,uxu::Vector,ucl::Vector,ucu::Vector)
...
ErrDetail(err::Vector,n::Int64,nb_comp::Int64,ncon::Int64)
"""
module Penalty
