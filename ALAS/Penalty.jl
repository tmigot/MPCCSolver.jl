...
liste des fonctions :
Quadratic(mp::NLPModels.AbstractNLPModel,err::Vector,ncc::Int64,x::Vector,yg::Vector,
...
Quadratic(mp::NLPModels.AbstractNLPModel,G::NLPModels.AbstractNLPModel,
                   H::NLPModels.AbstractNLPModel,err::Vector,ncc::Int64,
...
Lagrangian(mp::NLPModels.AbstractNLPModel,err::Vector,ncc::Int64,x::Vector,yg::Vector,
                   yh::Vector,rho::Vector,usg::Vector,ush::Vector,uxl::Vector,uxu::Vector,ucl::Vector,ucu::Vector)
Lagrangian(mp::NLPModels.AbstractNLPModel,G::NLPModels.AbstractNLPModel,
                   H::NLPModels.AbstractNLPModel,err::Vector,ncc::Int64,
                   x::Vector,yg::Vector,yh::Vector,
                   rho::Vector,
                   usg::Vector,ush::Vector,
...
_rho_detail(rho::Vector,mp::NLPModels.AbstractNLPModel,ncc::Int64)
...
"""
function quadratic(mp::NLPModels.AbstractNLPModel,err::Vector,ncc::Int64,x::Vector,yg::Vector,
                   yh::Vector,rho::Vector,usg::Vector,ush::Vector,uxl::Vector,uxu::Vector,ucl::Vector,ucu::Vector)
 n=length(mp.meta.x0)
...
"""
function lagrangian(mp::NLPModels.AbstractNLPModel,err::Vector,ncc::Int64,x::Vector,yg::Vector,
                   yh::Vector,rho::Vector,usg::Vector,ush::Vector,uxl::Vector,uxu::Vector,ucl::Vector,ucu::Vector)
 n=length(mp.meta.x0)
...
"""
function _rho_detail(rho::Vector,mp::NLPModels.AbstractNLPModel,ncc::Int64)
