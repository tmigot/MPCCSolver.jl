...
import PenMPCCmod.PenMPCC, PenMPCCmod.jac, PenMPCCmod.cons, PenMPCCmod.cons!
...
function RPen(x              :: Vector;
 ...
 return RPen(x,fx,gx,feas,norm_feas,
               ...
               wnew,step,sub_pb_solved,unbounded,solved)
end
...
function pen_start!(pen            :: PenMPCC,
                    ...
                    dual_feas      :: Vector  = Float64[],
                    norm_dual_feas :: Float64 = Inf,
                    lambda         :: Vector  = zeros(2*pen.n+3*pen.nb_comp))
