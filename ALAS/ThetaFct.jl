...
function theta(x :: FloatOrVector,
               r :: Float64)
output : FloatOrVector
"""
function theta(x :: FloatOrVector,
               r :: Float64)
...
function invtheta(x :: FloatOrVector,
                  r :: Float64)
"""
function invtheta(x :: FloatOrVector,
                  r :: Float64)
...
function dtheta(x :: FloatOrVector,
                r :: Float64)
"""
function dtheta(x :: FloatOrVector,
                r :: Float64)
...
function ddtheta(x :: FloatOrVector,
                 r :: Float64)
"""
function ddtheta(x :: FloatOrVector,
                 r :: Float64)
...
"""
function _alpha_theta_max_one_leaf(x  :: FloatOrVector,
                                   dx :: FloatOrVector,
                                   y  :: FloatOrVector,
                                   dy :: FloatOrVector,
                                   r  :: Float64,
...
"""
function _poly_degree_2_positif(a :: FloatOrVector,
                                b :: FloatOrVector,
                                c :: FloatOrVector)
